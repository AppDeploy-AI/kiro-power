...
- `POWER.md` - power manifest (activation keywords, onboarding, steering map)
- `mcp.json` - remote MCP server config for `https://api-v2.appdeploy.ai/mcp`
- `steering/` - workflow guidance loaded by Kiro on demand
